            ...
            if (data != 0) {
                for (i = 0; i < data.length; i++) {
                    ...
                    html2 += `  <div class="carousel-item ` + active + `">
                                    <img width="1920" height="537" class="d-block w-100" src="` + url + data[i].p_img + `" alt="First slide" id="buscarSlider"
...
function todoArticulos() {
    ...
    var categoria = $('#categoriaPost').val();
    var subcategoria = $('#subcategoria').val();
    var codalmm = localStorage.getItem('codalm');
    var formData = new FormData();
                    ...
                    html += `<div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 verProductosClick jar" style="cursor:pointer;"
                        ...
                        <div class="blog-card blog-card-blog">
                            ...
                            <div class="blog-table">
                                <h6 class="blog-category blog-text-success"  style="font-size:17px"><i class="far fa-newspaper"></i> </h6>
                                <h4 class="blog-card-caption"  style="font-size:17px">
                                    <a href="#" class="text-success">` + data[i].nomart.substr(0, 100) + `</a>
                                </h4>
